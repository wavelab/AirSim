...
void ASimModeBase::setupVehiclesAndCamera()
{
    ...
    //find all vehicle pawns
    {
        ...
        UE_LOG(LogTemp, Error, TEXT("NUM of array2: %d"), pawns.Num());
        ...
        for (AActor* pawn : pawns)
        {
            ...
            UE_LOG(LogTemp, Error, TEXT("name: %s"), *(vehicle_pawn->GetName()));

            // if ()

            if (!vehicle_pawn->GetMovementComponent()) {
                UE_LOG(LogTemp, Error, TEXT("OMG VEHICLE PAWNMOVE is BAD, below name"));
            } else {
                UE_LOG(LogTemp, Error, TEXT("All good under name"));
            }
            ...
            if (!pawn_sim_api_params.pawn->GetMovementComponent()) {
                UE_LOG(LogTemp, Error, TEXT("OMG VEHICLE Params is BAD, below name"));
            } else {
                UE_LOG(LogTemp, Error, TEXT("All good params"));
            }
