...
CustomCarPawnSimApi::CustomCarPawnSimApi(const Params& params,
    const CustomCarPawnApi::CarControls&  keyboard_controls)
    : PawnSimApi(params),
      keyboard_controls_(keyboard_controls)
{
    createVehicleApi(static_cast<ACustomCarPawn*>(params.pawn), params.home_geopoint);

    //TODO: should do reset() here?
    joystick_controls_ = CustomCarPawnApi::CarControls();
}
...
void CustomCarPawnSimApi::updateRenderedState(float dt)
{
...
void CustomCarPawnSimApi::updateRendering(float dt)
{
...
void CustomCarPawnSimApi::updateCarControls()
{
...
void CustomCarPawnSimApi::reset()
{
    PawnSimApi::reset();
...
//physics tick
void CustomCarPawnSimApi::update()
{
    vehicle_api_->update();
...
void CustomCarPawnSimApi::reportState(StateReporter& reporter)
{
