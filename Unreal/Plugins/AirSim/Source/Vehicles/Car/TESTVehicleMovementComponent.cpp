...
// #include "mkz_vsm/mkz_vsm.cpp"

#include "PhysXPublic.h"

UTESTVehicleMovementComponent::UTESTVehicleMovementComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
#if WITH_PHYSX
...
#if WITH_EDITOR
void UTESTVehicleMovementComponent::PostEditChangeProperty(struct FPropertyChangedEvent& PropertyChangedEvent)
{
...
// }
//
// void SetupDriveHelper(const UTESTVehicleMovementComponent* VehicleData, const PxVehicleWheelsSimData* PWheelsSimData, PxVehicleDriveSimData4W& DriveData)
// {
...
//
// 	UE_LOG(LogTemp, Warning, TEXT("Front left wheel pos: %f, %f"), WheelCentreOffsets[PxVehicleDrive4WWheelOrder::eFRONT_LEFT].X, WheelCentreOffsets[PxVehicleDrive4WWheelOrder::eFRONT_LEFT].Y)
//
// 	UE_LOG(LogTemp, Warning, TEXT("Rear left wheel pos: %f, %f"), WheelCentreOffsets[PxVehicleDrive4WWheelOrder::eREAR_LEFT].X,
// 	WheelCentreOffsets[PxVehicleDrive4WWheelOrder::eREAR_LEFT].Y)
//
// 	if (!PWheelsSimData) {
// 		UE_LOG(LogTemp, Warning, TEXT("BAD PWheelsSimData!"));
// 	} else {
// 		UE_LOG(LogTemp, Warning, TEXT("GOOD PWheelsSimData!"))
// 	}
//
...
// 	// AckermannSetup.mAxleSeparation = 2.5;
...
// 	// AckermannSetup.mFrontWidth = 1.5;
...
// void UTESTVehicleMovementComponent::SetupVehicleDrive(PxVehicleWheelsSimData* PWheelsSimData)
// {
...
// }
//
// void UTESTVehicleMovementComponent::UpdateSimulation(float DeltaTime)
// {
...
void UTESTVehicleMovementComponent::UpdateEngineSetup(const FVehicleEngineData& NewEngineSetup)
{
#if WITH_PHYSX
	// if (PVehicleDrive)
	// {
...
void UTESTVehicleMovementComponent::UpdateDifferentialSetup(const FVehicleDifferential4WData& NewDifferentialSetup)
{
#if WITH_PHYSX
	// if (PVehicleDrive)
	// {
...
void UTESTVehicleMovementComponent::UpdateTransmissionSetup(const FVehicleTransmissionData& NewTransmissionSetup)
{
#if WITH_PHYSX
	// if (PVehicleDrive)
	// {
...
void UTESTVehicleMovementComponent::Serialize(FArchive & Ar)
{
	Super::Serialize(Ar);
#if WITH_PHYSX
...
void UTESTVehicleMovementComponent::ComputeConstants()
{
